...
worker ranks report ready. Initialization failure terminates the engine and
surfaces the underlying error. Host registration can still compete with inference
for CPU and driver resources during this period.

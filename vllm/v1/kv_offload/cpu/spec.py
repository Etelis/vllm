...
class CPUOffloadingSpec(OffloadingSpec):
    ...
    def __init__(self, config: OffloadingConfig):
        ...
        self._unpopulated_region: SharedOffloadRegion | None = None
    ...
    def start_async_init(self, kv_caches: CanonicalKVCaches) -> None:
        ...
        self._unpopulated_region = self._create_region(rank, populate=False)
    ...
    def poll_async_init(self) -> OffloadingWorker | None:
        if self._worker is not None:
            return self._worker
        if self._unpopulated_region is not None:
            region = self._unpopulated_region
            self._unpopulated_region = None
    ...
    def close_async_init(self) -> None:
        if self._unpopulated_region is not None:
            self._unpopulated_region.cleanup()
            self._unpopulated_region = None
